...
//    public final static UUID UUID_RECEIVE = BluetoothHelper.sixteenBitUuid(0x2221);
    public final static UUID UUID_RECEIVE = UUID.fromString("0000fff2-0000-1000-8000-00805f9b34fb");
//    public final static UUID UUID_SEND = BluetoothHelper.sixteenBitUuid(0x2222);
    public final static UUID UUID_SEND = UUID.fromString("0000fff1-0000-1000-8000-00805f9b34fb");
//    public final static UUID UUID_DISCONNECT = BluetoothHelper.sixteenBitUuid(0x2223);
    public final static UUID UUID_DISCONNECT = UUID.fromString("0000fff3-0000-1000-8000-00805f9b34fb");
    public final static UUID UUID_CLIENT_CONFIGURATION = BluetoothHelper.sixteenBitUuid(0x2902);

//    public final static UUID UUID_SERVICE = BluetoothHelper.sixteenBitUuid(0x392a); //392a
//    public final static UUID UUID_RECEIVE = BluetoothHelper.sixteenBitUuid(0x392b);
//    public final static UUID UUID_SEND = BluetoothHelper.sixteenBitUuid(0x392c);
//    public final static UUID UUID_DISCONNECT = BluetoothHelper.sixteenBitUuid(0x392d);
//    public final static UUID UUID_CLIENT_CONFIGURATION = BluetoothHelper.sixteenBitUuid(0x2902);
